...
- Provide a helper that discovers LVCompare/LabVIEWCLI installs and scaffolds `configs/labview-paths.local.json` so
  local diff sessions can run in real mode without manual edits.
